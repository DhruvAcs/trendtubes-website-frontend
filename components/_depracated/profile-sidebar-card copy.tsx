...
const DeprecatedProfileSidebarCard = () => {
	return (
		<div className="h-full text-center rounded-md bg-secondary-bg">
			<div className="flex flex-col items-center px-6 py-4 bg-tertiary-bg rounded-t-md">
				<div
			...
			<div className="px-6 py-3 space-y-1 border-b-1 border-primary-border">
      ...
      <span className="font-medium truncate text-primary-color">
        RiznSun#7591
			...
			<div className="px-6 py-4 border-b-1 border-primary-border">
...
export default DeprecatedProfileSidebarCard;
