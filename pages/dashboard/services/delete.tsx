	...
	return (
		<>
            ...
            <span>euUrsDt</span> */}
										...
										<h4 className="mt-2">Delete Service Product</h4>
									</div>
								</div>
								{/* <hr className="my-4" /> */}
								...
								<div className="w-full mt-4 bg-secondary-bg rounded-lg">
									<div className="p-6">
										<p>
											Are you sure you want to delete this service product? This
											is not reversible.
										</p>
										<div className="flex items-center mt-4 space-x-4">
											...
											<Button
												onClick={async () => {
													await BackendApi.deleteService(router.query.id).catch(
														(_) => false
													);
